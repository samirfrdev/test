...
<html lang="en">
	...
	<head><base href="../">
		...
		<link rel="stylesheet" href="{{ url('assets/css/style.bundle.css')}}" />
		<link rel="stylesheet" href="{{ url('assets/plugins/custom/datatables/datatables.bundle.css')}}" />
		<link rel="stylesheet" href="{{ url('assets/plugins/custom/vis-timeline/vis-timeline.bundle.css')}}" />
	...
	<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled aside-enabled aside-fixed" style="--kt-toolbar-height:55px;--kt-toolbar-height-tablet-and-mobile:55px">
						...
						<div class="toolbar bg-transparent pt-6 mb-5" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-xxl d-flex flex-stack">
								...
								<div class="d-flex align-items-center gap-2 gap-lg-3">
									...
									class="btn btn-sm btn-white btn-active-white btn-active-color-primary
					...
					<div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
						...
						<div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
							...
							<div class="text-dark order-2 order-md-1">
								...
								<a href="https://keenthemes.com" target="_blank" class="text-gray-800 text-hover-primary">Dispatch</a>
							</div>
							<!--end::Copyright-->
							<!--begin::Menu-->
		...
		<script type="text/javascript" src="{{ url('assets/plugins/global/plugins.bundle.js')}}"></script>
		<script type="text/javascript" src="{{ url('assets/js/scripts.bundle.js')}}"></script>

		<!--end::Global Javascript Bundle-->
		<!--begin::Page Vendors Javascript(used by this page)-->
		<script type="text/javascript" src="{{ url('assets/plugins/custom/datatables/datatables.bundle.js')}}"></script>
		<script type="text/javascript" src="{{ url('assets/plugins/custom/vis-timeline/vis-timeline.bundle.js')}}"></script>
		...
		<script type="text/javascript" src="{{ url('assets/js/widgets.bundle.js')}}"></script>
		<script type="text/javascript" src="{{ url('assets/js/custom/widgets.js')}}"></script>
		<!-- <script type="text/javascript" src="{{ url('assets/js/custom/apps/chat/chat.js')}}"></script> -->
